...
namespace AVG
{
	...
	public:
		...
		float GetValue(DataID id, ExtraValueInput modifiers = ExtraValueInput::All) { return _valueData[id].GetValue(modifiers); }

		void SetValue(DataID id, float value, ExtraValueInput modifier = ExtraValueInput::Base) { _valueData[id].SetValue(value, modifier); }

		void ModValue(DataID id, float value, ExtraValueInput modifier = ExtraValueInput::Base) { _valueData[id].ModValue(value, modifier); }
